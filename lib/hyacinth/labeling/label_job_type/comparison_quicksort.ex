# lib/hyacinth/labeling/label_job_type/comparison_quicksort.ex
defmodule Hyacinth.Labeling.LabelJobType.ComparisonQuicksort do
  alias Hyacinth.Labeling.LabelJobType

  alias Hyacinth.Warehouse.Object
  alias Hyacinth.Labeling.{LabelJob, LabelSession, LabelElement}

  defmodule ComparisonQuicksortOptions do
    use Ecto.Schema
  ...
  @impl LabelJobType
  def name, do: "Comparison (Quick Sort)"

  @impl LabelJobType
  def options_changeset(params), do: ComparisonQuicksortOptions.changeset(%ComparisonQuicksortOptions{}, params)
  ...
  def group_objects(options, objects) do
    options = ComparisonQuicksortOptions.parse(options)
  ...
  defp build_lookup_table(%ComparisonQuicksortOptions{} = options, session_elements) do
